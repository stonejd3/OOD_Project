...
public class Main extends Application implements Observer {
	...
	public void update(Observable observable, Object o){
		if(observable instanceof LoginFormValidation) {
			if (o instanceof String[]) {
				...
				try {
					System.out.println("Now starting game with a " + s[5] + " deck");
					startGame(new Stage(), s[5]);
	...
	public static void startGame(Stage primaryStage, String deckClass) throws InstantiationException, IllegalAccessException, ClassNotFoundException {

		Server test = new Server(names, deckClass);
